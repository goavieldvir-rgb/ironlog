export const translations = {
  en: {
    ...
    dashboard: {
      ...
      editWeek: 'Edit week',
      editDay: 'Edit day',
      restDayToday: 'Rest day — nothing planned for today.',
      restDayPlanned: 'Rest day — nothing planned.',
      startSomethingElse: 'Start a different workout today',
      trainAnyway: 'Train anyway today',
      startAnythingHint: "Starts it for today without changing your weekly plan — handy when a session gets moved.",
      dayShort0: 'Sun',
      dayShort1: 'Mon',
      dayShort2: 'Tue',
      dayShort3: 'Wed',
    ...
    consent: {
      ...
      guardianNote: 'Your coach will contact them to confirm before, or shortly after, you start training.',
      scrollHint: 'Scroll to the end to continue',
      saving: 'Saving…',
      recordNote: 'Your acceptance is recorded with the date and the exact wording you read.',
    },
    feedback: {
      confirm: 'Confirm',
      saved: 'Saved',
    ...
    exercises: {
      ...
      pickerTitle: 'Add from the catalogue',
      pickerSubtitle: "Pick one and it's copied into your exercises, with your own history, units and notes. Not here? Create your own.",
    ...
    routines: {
      videoFor: 'Demo video for this exercise',
      videoTitle: 'Demo video',
      videoBody: 'Paste a link (YouTube, Instagram, anything). Your trainee taps it while logging to see how the exercise is done. It applies to the exercise itself, so it shows everywhere that exercise appears — not just in this routine.',
      videoPreview: 'Open the link to check it',
    ...
    workout: {
      ...
      addOneOffNote: 'Added for this session only — your routine stays as it is.',
      removeEntryTitle: 'Remove {name} from this workout?',
      removeEntryBody: 'The sets you logged for it will be discarded.',
      elapsed: '{min} min in',
    ...
    sessionCard: {
      prBadge: 'PR',
      prTitle: 'New personal record — your best was {prev}',
    ...
    restTimer: {
      doneTitle: 'Rest over',
      doneBody: 'Time for your next set.',
      notifyOn: 'Alerts on — you\'ll get a notification when rest ends while the app is in the background',
      notifyOff: 'Turn on an alert for when rest ends',
...
whoever set your account up for you.`,
    ...
    people: {
      ...
      termsOutdated: 'On older terms (v{version}) — will be asked again',
      termsNotAccepted: 'Has not accepted the terms yet',
  ...
  he: {
    ...
    dashboard: {
      ...
      editWeek: 'עריכת השבוע',
      editDay: 'עריכת היום',
      restDayToday: 'יום מנוחה — לא מתוכנן שום דבר להיום.',
      restDayPlanned: 'יום מנוחה — לא מתוכנן שום דבר.',
      startSomethingElse: 'התחלת אימון אחר היום',
      trainAnyway: 'להתאמן בכל זאת היום',
      startAnythingHint: 'מתחיל את האימון להיום בלי לשנות את התוכנית השבועית — שימושי כשאימון נדחה.',
      dayShort0: 'א׳',
      dayShort1: 'ב׳',
      dayShort2: 'ג׳',
      dayShort3: 'ד׳',
    ...
    common: {
      ...
      close: 'סגירה',
      gotIt: 'הבנתי',
      searchExercises: 'חיפוש תרגיל…',
      noMatches: 'אין תוצאות מתאימות',
      save: 'שמירה',
      saving: 'שומר…',
      cancel: 'ביטול',
      delete: 'מחיקה',
    ...
    exercises: {
      ...
      pickerTitle: 'הוספה מהקטלוג',
      pickerSubtitle: 'בחרו תרגיל והוא יועתק לתרגילים שלכם, עם ההיסטוריה, היחידות וההערות שלכם. לא נמצא? צרו תרגיל משלכם.',
    ...
    routines: {
      videoFor: 'סרטון הדגמה לתרגיל הזה',
      videoTitle: 'סרטון הדגמה',
      videoBody: 'הדביקו קישור (יוטיוב, אינסטגרם, כל דבר). המתאמן יקיש עליו בזמן התיעוד כדי לראות איך מבצעים את התרגיל. הקישור משויך לתרגיל עצמו, ולכן יופיע בכל מקום שבו התרגיל מופיע — לא רק בתוכנית הזו.',
      videoPreview: 'פתחו את הקישור לבדיקה',
    ...
    workout: {
      sessionSaved: 'האימון נשמר',
      addOneOffNote: 'נוסף לאימון הזה בלבד — התוכנית שלכם נשארת כמו שהיא.',
      removeEntryTitle: 'להסיר את {name} מהאימון הזה?',
      removeEntryBody: 'הסטים שתיעדתם עבורו יימחקו.',
    ...
    sessionCard: {
      prBadge: 'שיא',
      prTitle: 'שיא אישי חדש — הקודם היה {prev}',
      removeExercise: 'הסרת התרגיל הזה מהאימון',
      removeSet: 'הסרת הסט הזה',
      moveUp: 'העברה למעלה',
      moveDown: 'העברה למטה',
      cardioBadge: 'קרדיו',
      bodyweightBadge: 'משקל גוף',
    ...
    restTimer: {
      doneTitle: 'המנוחה נגמרה',
      doneBody: 'זמן לסט הבא.',
      notifyOn: 'התראות פעילות — תקבלו התראה כשהמנוחה נגמרת גם כשהאפליקציה ברקע',
      notifyOff: 'הפעלת התראה לסיום המנוחה',
...
אפשר לחפש לפי שם תרגיל, שם תוכנית, או כל דבר שכתבתם בהערות, ולסנן לפי טווח תאריכים או קטגוריה (כוח / מוביליטי / קרדיו) באמצעות הלשוניות.`,
    ...
    people: {
      ...
      termsOutdated: 'על תנאים ישנים (גרסה {version}) — יתבקש/תתבקש לאשר שוב',
      termsNotAccepted: 'עדיין לא אישר/ה את התנאים',
      guardian: 'אפוטרופוס: {name}',
      admin: 'ניהול',
      title: 'אנשים',
