export const translations = {
  en: {
    ...
    workout: {
      ...
      swapNote: "Choose from your existing exercises. If the one you want isn't in the list yet, add it via Exercises first, then come back and swap.",
      swapConfirm: 'Swap',
...
whoever set your account up for you.`,
  ...
  he: {
    ...
    workout: {
      ...
      swapNote: 'בחרו מתוך התרגילים הקיימים שלכם. אם התרגיל שאתם רוצים עדיין לא ברשימה, הוסיפו אותו קודם דרך התרגילים, ואז חזרו להחליף.',
      swapConfirm: 'החלף',
    },
    sessionCard: {
      cardioBadge: 'קרדיו',
